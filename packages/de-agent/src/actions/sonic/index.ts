...
import { getSonicPointsAction } from "./getSonicPoints.js";
...
export { getSonicPointsAction } from "./getSonicPoints.js";
...
export const sonicActions: Record<string, Action> = {
  ...
  [ACTION_NAMES.SONIC_GET_POINTS]: getSonicPointsAction,
} as const;
