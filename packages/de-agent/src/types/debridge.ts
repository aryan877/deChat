...
// Basic quote response (simplified)
...
// Enhanced quote response based on actual API response
export interface deBridgeEnhancedQuoteResponse {
  estimation: {
    srcChainTokenIn: {
      address: string;
      chainId: number;
...
export const getDebridgeTokensInfoSchema = z.object({
  ...
  chainId: chainIdSchema
    .optional()
    .describe(
      "Chain ID to get token information for. Examples: '1' (Ethereum), '56' (BNB Chain), '7565164' (Solana), '100000014' (Sonic). Defaults to '100000014'"
    ),
